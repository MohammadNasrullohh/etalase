...
- Refactored components to eliminate inline glass styles and hardcoded Hex/RGB colors.
- Created JurnalCard, JurnalDetailModal, JurnalList, CalendarWidget, and DocumentationPanel.
