...
## Corpus Check
- 286 files · ~356,557 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3422 nodes · 7384 edges · 196 communities (166 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 125 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0237047b`
...
Cohesion: 0.05
Nodes (64): jurnal, pimpinan, serviceEvents, db, pool, buffer, GET(), GET() (+56 more)
...
Cohesion: 0.21
Nodes (13): AdminLayout(), Page(), AuthoringLayout(), getMeAction(), LAWET_API_URL, canApproveJurnal(), isAdminUser(), normalizedRoleName() (+5 more)
...
Cohesion: 0.07
Nodes (42): buildSelectorSegment(), checkBorders(), checkClippedOverflow(), checkElementBorders(), checkElementBordersDOM(), checkElementClippedOverflow(), checkElementClippedOverflowDOM(), checkElementHeroEyebrow() (+34 more)
...
Cohesion: 0.14
Nodes (16): AuthoringShellClient(), Props, AuthoringSidebarClient(), Props, SiteTitle(), SiteTitleContext, SiteTitleProvider(), useSiteTitle() (+8 more)
...
Cohesion: 0.14
Nodes (22): JurnalSayaPage(), extractList(), fetchLawetList(), getJurnalWorkspaceAction(), getMyJurnalsAction(), isOwnedBy(), isRecord(), JsonRecord (+14 more)

### Community 120 - "SAFE_TAGS"
Cohesion: 0.21
Nodes (9): ApprovalDetailPage(), formatDate(), JurnalDetail, fetchWithToken(), getApprovalJurnalAction(), getApprovalQueueAction(), LAWET_API_URL, ApprovalQueue() (+1 more)
...
Cohesion: 0.11
Nodes (24): checkPageTypography(), resolveSerif(), firstOverusedGoogleFont(), checkStaticPageTypography(), checkBorders(), checkElementBorders(), checkElementBordersDOM(), checkElementItalicSerif() (+16 more)
...
## Knowledge Gaps
- **918 isolated node(s):** `extends`, `COMMON_DEV_PORTS`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES` (+913 more)
...
- **Why does `el()` connect `Community 31` to `inline-ignores.mjs`, `Community 3`, `Community 4`, `package.json`, `Community 7`, `Community 16`, `Community 23`, `Community 25`, `Community 30`, `Community 37`, `Community 38`, `Community 47`, `parseRgb`, `captureElementToBlob`, `parseAnyColor`, `index.tsx`, `resolveLengthPx`, `refreshParamsPanel`, `scheduleLazyVisualContrast`, `Responsive Design`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `buffer` connect `Community 0` to `manual-edit-routes.mjs`, `Community 39`, `Community 40`, `readConfig`, `readWorkspacePatterns`, `Community 47`, `Community 54`, `Community 28`, `isGeneratedFile`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `LandingView()` connect `index.tsx` to `Community 31`?**
