# Graph Report - ALAS  (2026-07-29)

## Corpus Check
- 263 files · ~349,497 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3357 nodes · 7195 edges · 194 communities (164 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34ed22fb`
...
- `POST()` --references--> `buffer`  [EXTRACTED]
  src/app/api/admin/hero/route.ts → .github/skills/impeccable/scripts/live-discard-manual-edits.mjs
...
Cohesion: 0.12
Nodes (18): jurnal, pimpinan, db, pool, GET(), GET(), GET(), POST() (+10 more)
...
Cohesion: 0.17
Nodes (15): JurnalDetailModal(), JurnalDetailModalProps, KategoriDropdown(), KategoriDropdownProps, ACCENT_COLORS, CATEGORY_COLORS, CATEGORY_LABELS, CATEGORY_STYLES (+7 more)
...
Cohesion: 0.33
Nodes (6): 1. API Publik (Unauthenticated), 1. Health Check, 1. List Pimpinan Aktif, 2. Detail Profil Pimpinan, B. Profil Pimpinan, C. System Utility

### Community 7 - "Community 7"
Cohesion: 0.13
Nodes (52): abortSvelteComponentInjection(), cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure(), cleanup(), cleanupAcceptedSession(), clearAnnotations(), clearInsertPicking() (+44 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (21): LAWET_API_URL, submitJurnalAction(), LAWET_API_URL, uploadDokumenAction(), uploadFotoAction(), CustomFieldItem, DokumenPendukungItem, DokumentasiItem (+13 more)
...
Cohesion: 0.29
Nodes (7): 1. Create atau Upsert Jurnal, 2. Update Parsial Jurnal, 3. Toggle Visibilitas Dokumen Pendukung, 4. Detail Jurnal Internal (View Admin), 5. List Semua Jurnal (Published & Draft), 6. Soft Delete Jurnal, A. Jurnal & Dokumentasi
...
Cohesion: 0.16
Nodes (12): AuthoringShellClient(), Props, AuthoringSidebarClient(), Props, SiteTitle(), SiteTitleContext, SiteTitleProvider(), useSiteTitle() (+4 more)

### Community 15 - "Community 15"
Cohesion: 0.20
Nodes (9): ALAS — Arsip Langkah Bawaslu Kebumen, API & Integrasi Lengkap, Arsitektur Singkat, Daftar Isi, Environment Variables, Kontributor, Struktur Direktori, Tech Stack (+1 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (76): borderColorsFromStyle(), borderWidthsFromStyle(), checkClippedOverflow(), checkElementClippedOverflow(), checkElementClippedOverflowDOM(), checkElementGptBorderShadow(), checkElementGptBorderShadowDOM(), checkElementHeroEyebrow() (+68 more)

### Community 18 - "Community 18"
Cohesion: 0.17
Nodes (14): ApprovalDetailPage(), formatDate(), JurnalDetail, approveJurnalAction(), fetchWithToken(), getApprovalJurnalAction(), getApprovalQueueAction(), LAWET_API_URL (+6 more)

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (32): averageRgb01(), buildInsertPlaceholderSnapshotFromDom(), buildPickedAnchorSnapshot(), captureAndEmit(), captureChromeNodes(), captureElementFromRenderedAncestor(), captureElementToBlob(), checkpointPayload() (+24 more)
...
Cohesion: 0.07
Nodes (49): extractPlatform(), ACK_EXTS, applyConfigSource(), applyDetectorConfigSource(), clampByte(), cloneDefaultConfig(), CO_SCAN_STYLE_NAMES, coLocatedStylesheets() (+41 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (36): applyGlobalBarLabelState(), barPaletteForTheme(), brandMarkSvg(), buildDesignHeader(), buildSavingRow(), buildSteerProcessingDots(), designPanelCss(), detectPageTheme() (+28 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (56): _(), cssSafe(), renderColorTiles(), synthesizeRamp(), ae(), be(), bt(), Ce() (+48 more)
...
Cohesion: 0.07
Nodes (65): applyOriginalAttrsToSvelteAnchor(), applyParamDefaults(), applyParamValue(), applyPlaceholderDimensions(), applySavedSessionMeta(), buildParamsPanel(), clampVariantIndex(), clearHandled() (+57 more)
...
Cohesion: 0.05
Nodes (34): Alur Data, Arsip publik, Arsitektur ALAS, Authoring dan approval, Batas Sistem, Konfigurasi dan Infrastruktur, Service API, Entity-Relationship Diagram ALAS (+26 more)
...
Cohesion: 0.15
Nodes (25): applyStaticDeclaration(), buildStaticStyleMap(), collectStaticCssRules(), compareStaticPriority(), cssPropToCamel(), expandStaticBoxValues(), expandStaticDeclaration(), extractStaticColor() (+17 more)
...
Cohesion: 0.11
Nodes (38): applyEditing(), buildLocatorForLeaf(), clearStoredManualApplyState(), copyEditContainerContext(), copyEditLeafContext(), copyToClipboard(), dismissToast(), documentRefForElement() (+30 more)
...
Cohesion: 0.13
Nodes (17): buildBorderOverrideMap(), buildStaticWindow(), collectStaticCssText(), normalizeColorForCheck(), StaticDocument, checkStaticPageTypography(), detectHtml(), STATIC_ELEMENT_RULES (+9 more)
...
Cohesion: 0.24
Nodes (12): AdminLayout(), AuthoringLayout(), isAdminUser(), normalizedRoleName(), getAdminUser(), getMeAction(), LAWET_API_URL, LawetUser (+4 more)
...
### Community 95 - "authenticateService"
Cohesion: 0.20
...
Cohesion: 0.29
Nodes (12): latestCritique(), kebab(), listSnapshotsForSlug(), main(), nowFilenameStamp(), parseFrontmatter(), readLatestSnapshot(), readTrend() (+4 more)
...
Cohesion: 0.25
Nodes (10): PATCH(), DELETE(), GET(), PATCH(), GET(), DELETE(), GET(), PATCH() (+2 more)
...
Cohesion: 0.12
Nodes (18): checkPageTypography(), checkTypography(), isBrandFontOnOwnDomain(), firstOverusedGoogleFont(), checkBorders(), checkElementBorders(), checkElementBordersDOM(), checkPageTypography() (+10 more)

### Community 130 - "scheduleSteerFocusRecover"
Cohesion: 0.27
...
### Community 132 - "checkElementTextOverflowDOM"
Cohesion: 0.32
...
Cohesion: 0.42
Nodes (6): JurnalSayaPage(), getMyJurnalsAction(), LAWET_API_URL, MyJurnalItem, getKategoriLabel(), MyJurnalCard()

### Community 135 - "iOS platform"
Cohesion: 0.25
...
Cohesion: 0.12
Nodes (19): siteSettings, HeroSettingsPanel(), Props, AdminPage(), ALLOWED_FORMATS, heroDirectory(), isManagedHeroPath(), PATCH() (+11 more)

### Community 142 - "Menjalankan Secara Lokal"
Cohesion: 0.25
Nodes (8): 1. Clone & Install, 2. Jalankan Database, 3. Setup Environment, 4. Jalankan Migrasi, 5. Seed Data (opsional, untuk development), 6. Jalankan Dev Server, Menjalankan Secara Lokal, Prasyarat
...
### Community 147 - "Deploy (Docker - Produksi dengan GHCR)"
Cohesion: 0.29
Nodes (7): 1. Clone repositori ke server, 2. Setup Environment Variables, 3. Jalankan Container, 4. Jalankan Migrasi Database, Deploy (Docker - Produksi dengan GHCR), Health Check, Services yang dijalankan:
...
### Community 152 - "Adaptation Strategies"
Cohesion: 0.40
...
### Community 153 - "A. Jurnal & Kegiatan"
Cohesion: 0.33
Nodes (6): 1. List Jurnal, 2. Detail Jurnal, 3. Kalender Kegiatan, 4. Statistik & Rekapitulasi Tahunan, 5. List Kategori Jurnal, A. Jurnal & Kegiatan
...
### Community 157 - "B. Manajemen Pimpinan"
Cohesion: 0.40
Nodes (5): 1. Create atau Upsert Pimpinan, 2. Service API (Bearer-Protected), 2. Update Profil Pimpinan, 3. Soft Delete Pimpinan, B. Manajemen Pimpinan

### Community 158 - "Cara Integrasi Lawet Hub ➔ ALAS"
Cohesion: 0.40
Nodes (5): 1. Sinkronisasi Token Auth, 2. Alur Manajemen Aset Media (MinIO), 3. Implementasi HTTP Client (Python httpx), 4. Strategi Penanganan Kegagalan Sync (Resilience), Cara Integrasi Lawet Hub ➔ ALAS

### Community 159 - "isGeneratedFile"
Cohesion: 0.70
Nodes (4): hasGeneratedHeader(), HEADER_MARKERS, isGeneratedFile(), isGitIgnored()

### Community 160 - "get-pimpinan-detail.ts"
Cohesion: 0.12
...
### Community 187 - "checkHeroEyebrow"
Cohesion: 0.40
...
### Community 192 - "4. Plan three variants: identity first, then mode, then axes"
Cohesion: 0.40
...
### Community 198 - "live-target.mjs"
Cohesion: 0.47
Nodes (6): applyPatchText(), envProjectDir(), looksLikeApplyPatch(), normalizeGitHubEvent(), normalizeHookEvent(), parseGitHubToolArgs()

## Knowledge Gaps
- **927 isolated node(s):** `extends`, `COMMON_DEV_PORTS`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES` (+922 more)
...
- **Why does `el()` connect `captureElementToBlob` to `inline-ignores.mjs`, `Community 3`, `Community 4`, `Community 7`, `Community 16`, `serializeFindings`, `Community 23`, `Community 25`, `Community 29`, `Community 30`, `Community 31`, `Community 37`, `parseRgb`, `handleManualEditActivity`, `parseAnyColor`, `index.tsx`, `resolveLengthPx`, `refreshParamsPanel`, `collectBrowserFindings`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `buffer` connect `package.json` to `manual-edit-routes.mjs`, `Community 39`, `Community 40`, `readConfig`, `readWorkspacePatterns`, `index.ts`, `Community 54`, `Community 28`, `isGeneratedFile`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `v()` connect `Community 26` to `critique-storage.mjs`, `Community 16`, `Community 51`, `checkHeroEyebrow`, `Community 29`?**
