# Graph Report - ALAS  (2026-08-03)

## Corpus Check
- 280 files · ~354,606 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3437 nodes · 7341 edges · 203 communities (170 shown, 33 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 123 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6232e2f5`
...
Cohesion: 0.18
Nodes (12): pimpinan, serviceEvents, IncomingDokumen, JurnalPayload, upsertJurnal(), PimpinanPayload, upsertPimpinan(), ServiceEventInput (+4 more)
...
Cohesion: 0.14
Nodes (14): MediaActionResult, uploadDokumenAction(), uploadFotoAction(), CustomFieldItem, DokumenPendukungItem, DokumentasiItem, JurnalSubmissionPayload, PihakTerkaitItem (+6 more)
...
Cohesion: 0.06
Nodes (42): AdminLayout(), ApprovalDetailPage(), formatDate(), JurnalDetail, AuthoringShellClient(), Props, JurnalSayaPage(), AuthoringLayout() (+34 more)
...
Cohesion: 0.11
Nodes (18): devDependencies, dependency-cruiser, drizzle-kit, eslint, eslint-config-next, jsdom, postcss, tailwindcss (+10 more)
...
Cohesion: 0.07
Nodes (60): ACK_EXTS, bumpEditCount(), clampByte(), clampGroupedToBudget(), clampToBudget(), CO_SCAN_STYLE_NAMES, coLocatedStylesheets(), colorIgnoreKey() (+52 more)
...
Cohesion: 0.10
Nodes (37): appendOriginToDirective(), buildTagBlock(), commentClose(), commentOpen(), CONFIG_PATH, detectLineEnding(), __dirname, ensureLiveGitIgnores() (+29 more)
...
Cohesion: 0.08
Nodes (21): Adaptation Strategies, Assess Adaptation Challenge, Implement & Verify, Orientation & foldables, Phone → Tablet (iPad / large screens), Platform → platform (iOS ↔ Android), Web → native (porting a website or web app), 1. Accessibility (VoiceOver / TalkBack) (+13 more)
...
Cohesion: 0.18
Nodes (14): useJurnalFilter(), FuturisticLine(), FuturisticLineProps, easeOutExpo(), HeroLogoReveal(), HeroSubtitleReveal(), HeroTitleReveal(), randomSymbol() (+6 more)
...
Cohesion: 0.17
Nodes (11): name, private, scripts, arch:check, boundary:check, boundary:test, build, dev (+3 more)
...
Cohesion: 0.21
Nodes (7): jurnal, db, pool, GET(), GET(), getJurnalCalendar(), getJurnalDetail()
...
Cohesion: 0.14
Nodes (29): mergeDesignSystemFindings(), detectUrl(), runVisualContrastFallback(), serializeDesignSystemForBrowser(), buildStaticWindow(), collectStaticCssText(), checkStaticPageTypography(), detectHtml() (+21 more)
...
Cohesion: 0.17
Nodes (23): GET(), POST(), PATCH(), DELETE(), GET(), PATCH(), GET(), POST() (+15 more)
...
### Community 135 - "collectVisualContrastCandidates"
Cohesion: 0.25
...
### Community 140 - "colorize.md"
Cohesion: 0.47
Nodes (6): applyPatchText(), envProjectDir(), looksLikeApplyPatch(), normalizeGitHubEvent(), normalizeHookEvent(), parseGitHubToolArgs()

### Community 141 - "readWorkspacePatterns"
Cohesion: 0.12
Nodes (21): siteSettings, HeroSettingsPanel(), Props, HeroSubtitleSettingsPanel(), AdminPage(), ALLOWED_FORMATS, heroDirectory(), isManagedHeroPath() (+13 more)
...
### Community 151 - "cli"
Cohesion: 0.36
Nodes (3): JurnalSubmitForm(), PengajuanView(), PengajuanFormWidget()

### Community 152 - "iOS platform"
Cohesion: 0.25
...
Cohesion: 0.29
Nodes (7): Alur Data, Arsip publik, Arsitektur ALAS, Batas Sistem, Konfigurasi dan Infrastruktur, Service API, Visibilitas workflow
...
### Community 193 - "Implement Animations"
Cohesion: 0.29
...
## Knowledge Gaps
- **953 isolated node(s):** `extends`, `COMMON_DEV_PORTS`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES` (+948 more)
...
- **Why does `el()` connect `Community 31` to `inline-ignores.mjs`, `Community 3`, `Community 4`, `collectVisualContrastCandidates`, `Community 7`, `Community 16`, `Community 23`, `Community 25`, `Community 30`, `Community 37`, `Community 38`, `Community 47`, `parseRgb`, `captureElementToBlob`, `index.tsx`, `resolveLengthPx`, `refreshParamsPanel`, `scheduleLazyVisualContrast`, `Responsive Design`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `buffer` connect `package.json` to `resolveWorkspaceProjectRoot`, `manual-edit-routes.mjs`, `Community 39`, `Community 40`, `readConfig`, `SAFE_TAGS`, `readWorkspacePatterns`, `Community 54`, `Community 28`, `isGeneratedFile`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `v()` connect `Community 26` to `Community 3`, `captureElementToBlob`, `Community 47`, `Community 51`, `context-signals.mjs`, `resolveLengthPx`?**
